...
This project now runs as a fully free local pipeline. Summaries, tagging, sector classification, and market-impact analysis are all generated by the built-in heuristic logic, so there is no external AI API dependency.
